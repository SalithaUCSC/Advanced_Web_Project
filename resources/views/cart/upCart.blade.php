                                                    ...
                                                    <div class="col-lg-12" style="float: right;">
                                                        <table class="table">
                                                            <tr>
                                                                ...
                                                                <th width="200px;" class="cart_quantity">
                                                                    <div class="cart_quantity_button">
                                                                        ...
                                                                        <input type="number" size="2" value="{{$row->qty}}" name="qty" id="upCart{{ $count }}">
                                                                        <br>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="/cart" class="btn btn-warning btn-sm">update</a></td>
                        ...
                        <div class="col-lg-3" style="float: right;">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <br>
                                    <a href="/cart/checkout" class="btn btn-block btn-dark btn-md">CHECKOUT</a>
                                </div>
                            </div>
                        </div>
                    @else
